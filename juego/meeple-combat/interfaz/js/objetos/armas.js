...
// Contiene los nombres de todas las armas dentro de la colleción armas_naturales.
const nombre_armas_naturales = Object.keys(armas_naturales).filter(nombre => {
    if (
        // Armas excluidas.
        nombre !== "nada"
    ) {
